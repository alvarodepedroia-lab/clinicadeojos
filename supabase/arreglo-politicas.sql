-- ============================================================================
-- ARREGLO URGENTE  ·  Clínica de Ojos S.R.L.
-- ----------------------------------------------------------------------------
-- Corrige una recursión infinita en las políticas de seguridad que dejaba a
-- todo el personal fuera del panel: el login funcionaba, pero al entrar la base
-- no podía leer el perfil y el sistema devolvía al usuario a la pantalla de
-- ingreso sin ningún mensaje.
--
-- Cómo se usa:
--   1. Supabase -> SQL Editor -> New query.
--   2. Pegar todo esto y apretar "Run".
--
-- No toca datos: solo reemplaza políticas. Se puede correr más de una vez.
-- ============================================================================
...
-- ─── Verificación ───────────────────────────────────────────────────────────
-- Tiene que devolver una fila por cada persona del equipo (13).
select username, full_name, role,
       case when active then 'activo' else 'inactivo' end as estado,
       case when must_change_password then 'temporal' else 'propia' end as contrasena
